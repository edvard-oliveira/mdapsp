package experimentos.multiplos.worflows;
 ...
 *
 */
public class Experimento21_MultWorflow {

    public static void main(String[] args) {
        Experimento21_MultWorflow obj = new Experimento21_MultWorflow();
        String output = obj.executar();
    }

    public String executar() {

        Log.printLine("Experimento 21");
        //Parametrização do Experimento
        Parameters.SchedulingAlgorithm  f1 = Parameters.SchedulingAlgorithm.EDVSCHED2;
        String                          f2 = "Protein1AGY_Final.xml";
        int                             f3 = Utilidades.COM_NUVEM;
        ...
        //Ajuste 1 para multiplos Workflows
...
//          daxPaths.add("/Users/weiweich/NetBeansProjects/WorkflowSim-1.0/config/dax/Montage_1000.xml");
            ...
            //Ajuste 2 para multiplos Workflows
            ...
            Logger.getLogger(Experimento21_MultWorflow.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "";
    }
}
