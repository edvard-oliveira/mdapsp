 ...
 *
 */
public class Experimento15_MultWorflow {

    public static void main(String[] args) {
        Experimento15_MultWorflow obj = new Experimento15_MultWorflow();
        String output = obj.executar();
    }

    public String executar() {

        Log.printLine("Experimento 15");
...
//          daxPaths.add("/Users/weiweich/NetBeansProjects/WorkflowSim-1.0/config/dax/Montage_1000.xml");
            ...
            Logger.getLogger(Experimento15_MultWorflow.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "";
    }
}
