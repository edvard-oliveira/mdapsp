...
public class Experimento6 {
    ...
    public String executar() {
        ...
        Log.printLine("Experimento 6");
        //Parametrização do Experimento
        Parameters.SchedulingAlgorithm  f1 = Parameters.SchedulingAlgorithm.ROUNDROBIN;
...
//          daxPaths.add("/Users/weiweich/NetBeansProjects/WorkflowSim-1.0/config/dax/Montage_1000.xml");
            ...
            Logger.getLogger(Experimento6.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "";
    }
}
