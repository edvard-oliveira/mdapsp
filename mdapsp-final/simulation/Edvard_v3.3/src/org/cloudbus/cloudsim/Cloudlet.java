...
public class Cloudlet {
    ...
    //Tempo Extra da Transfência de Arquivos em Segundos
    private long extraTime;

    //Tamanho Extra da Transfência de Arquivos em MI (Milhões de Instruções)
    private long extraSize;

    private double networkDelayTime; //Momento em que a tarefa é enviada para o recurso.

    private String name; //Nome atribuído para tarefa no arquivo DAX
    
    private long initialCloudletLength;  //Armazenar o tamanho inicial da Cloudlet (sem overheads)
    ...
    public boolean setCloudletLength(final long cloudletLength) {
        ...
        if (initialCloudletLength == 0 ) {
            initialCloudletLength = cloudletLength;
        }
    ...
    public void setExtraTime(long extraSize) {
        this.extraTime = extraSize;
    }
    ...
    public double getNetworkDelayTime() {
        return networkDelayTime;
    }

    public void setNetworkDelayTime(double sendTime) {
        this.networkDelayTime = sendTime;
    }
    ...
    public long getInitialCloudletLength() {
        return initialCloudletLength;
    }

    public void setInitialCloudletLength(long initialCloudletLength) {
        this.initialCloudletLength = initialCloudletLength;
    }
