...
public class WorkflowSimMultipleClusterExample1 extends WorkflowSimBasicExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            String daxPath = "" + System.getProperty("user.dir") + "/config/dax/Inspiral_1000.xml";
             ...
             */
            System.out.println("Parameters.getVmNum()="+Parameters.getVmNum());
            List<CondorVM> vmlist0 = createVM(wfEngine.getSchedulerId(0), Parameters.getVmNum() / 3, 0);
            List<CondorVM> vmlist1 = createVM(wfEngine.getSchedulerId(0), Parameters.getVmNum() / 3, 100);
            List<CondorVM> vmlist2= createVM(wfEngine.getSchedulerId(0), Parameters.getVmNum() / 3, 2000);
