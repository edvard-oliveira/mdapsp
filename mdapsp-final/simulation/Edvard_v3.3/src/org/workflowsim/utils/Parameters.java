...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        STATIC, FCFS, ROUNDROBIN, INVALID, EDVSCHED1, EDVSCHED2
    }  
    //*** EDVSCHED1 - Algoritmo de Escalonamento do Edvard v1 - baseado nos 
    //parâmetros ger, amin e pop. ***
    //*** EDVSCHED2 - Algoritmo de Escalonamento do Edvard v2- baseado nos 
    //no tamanho da carga de trabalho (Workload). ***
    ...
    public enum PlanningAlgorithm{
        INVALID, RANDOM, HEFT, DHEFT, EDVARD1
    }
