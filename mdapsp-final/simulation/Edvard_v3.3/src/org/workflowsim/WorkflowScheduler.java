...
import br.usp.icmc.lasdpc.workflowarch.edvard.MultiDatacenterSchedulingAlgorithm;
import br.usp.icmc.lasdpc.workflowarch.edvard.WorkloadLengthSchedulingAlgorithm;
    ...
    public void processEvent(SimEvent ev) {
        switch (ev.getTag()) {
            ...
            case CloudSimTags.CLOUDLET_RETURN:
                processCloudletReturn(ev);
//                System.out.println("Cloudlet retornada.");
                break;
...
//                System.out.println("Cloudlet enviada.");
                break;
            case WorkflowSimTags.CLOUDLET_UPDATE:
//                System.out.println("Cloulet atualizada (em andamento)...");
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            //Acrescentado para permitir o uso do algoritmo de escalonamento Edvard1    
            case EDVSCHED1:
                algorithm = new MultiDatacenterSchedulingAlgorithm();
                break;
            case EDVSCHED2:
                algorithm = new WorkloadLengthSchedulingAlgorithm();
                break;
    ...
    protected void processVmCreate(SimEvent ev) {
        //System.out.println("Rodou criação de VM...");
        ...
        if (getVmsCreatedList().size() == getVmList().size() - getVmsDestroyed()) {
            submitCloudlets();
//            System.out.println("Executou submitCloudlets()!");
        } else {
            ...
            if (getVmsRequested() == getVmsAcks()) {
                ...
                if (getVmsCreatedList().size() > 0) { // if some vm were created
                    submitCloudlets();
//                    System.out.println("submitCloudlets invocado!");
    ...
    protected void processCloudletUpdate(SimEvent ev) {
        ...
        BaseSchedulingAlgorithm scheduler
                = getScheduler(Parameters.getSchedulingAlgorithm());
        ...
        for (Cloudlet cloudlet : scheduledList) {
            ...
            Log.printLine("Cloudlet Nro. " + cloudlet.getCloudletId() 
                    +  " escalonada para a VM: " + vmId
                    + "| Datacenter ID = "
    ...
    protected void processCloudletReturn(SimEvent ev) {
        //System.out.println("Retorno da cloudlet.");
        ...
        CondorVM vm = null;
        for (Vm cvm : getVmsCreatedList()) {
            if (cvm.getId() == cloudlet.getVmId()) {
                vm = (CondorVM) cvm;
        ...
        cloudlet.setNetworkDelayTime(CloudSim.clock()+  NetworkTopology.getDelay(this.getId(), cloudlet.getResourceId()));
...
//        System.out.println("WorkflowScheduler--> lista de jobs = " + list.size());
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
//        System.out.println("Tasks da lista de JOBS = " + list.get(0).getTaskList().size());
//        System.out.println("Tasks filhas do JOB = " + list.get(0).getChildList().size());
//        System.out.println("Tasks filhas de uma filha do JOB = " + 
//                list.get(0).getChildList().get(0).getChildList().size());
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
        getCloudletList().addAll(list);

//        System.out.println("lista de cloudlets = " + getCloudletList().size());
        //pause(10.0);
    ...
    protected void processResourceCharacteristicsRequest(SimEvent ev) {
        ...
        //System.out.println("Workflowwwwwwww");
