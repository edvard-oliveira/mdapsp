...
import br.usp.icmc.lasdpc.workflowarch.edvard.SimplePlanningAlgorithm;
...
public final class WorkflowPlanner extends SimEntity {
    ...
    public WorkflowPlanner(String name, int schedulers) throws Exception {
        super(name); //Construtor da Super Classe SimEntity
...
//                System.out.println("WorkFlowPlanner.TaskList = " + getTaskList().size());
                break;
...
//        System.out.println("Planner.TaskList=" + getTaskList().size());
//        System.out.println("Planner.VmList=" + getWorkflowEngine().getAllVmList().size());
        try {
            planner.run();
        } catch (Exception e) {
    ...
    private BasePlanningAlgorithm getPlanningAlgorithm(PlanningAlgorithm name) {
        ...
        switch (name) {
            ...
            case DHEFT:
                ...
                break;
            case EDVARD1:
                planner = new SimplePlanningAlgorithm();
                break;
