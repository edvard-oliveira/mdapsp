...
public final class WorkflowEngine extends SimEntity {
    ...
    public WorkflowEngine(String name, int schedulers) throws Exception {
        ...
        //System.out.println("***************WorkflowEngine.JobsList--->>> " + this.jobsList.size());
    }
    ...
    protected void processJobSubmit(SimEvent ev) {
        ...
        setJobsList(list);
        //Log.printLine("WorkflowEngine.jobList.size() = " + this.getJobsList().size());
    }
    ...
    protected void submitJobs() {
        ...
        //Regras de negócio de Escalonamento (Brokering)
        List<Job> list = getJobsList();
//        System.out.println("WorkflowEngine:::--->>Escalonando JOBS");
