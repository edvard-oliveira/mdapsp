 ...
 *
 */
public class TemplateProgram5 {

    public static void main(String[] args) {
        TemplateProgram5 obj = new TemplateProgram5();
    ...
    public String executar() {
        ...
        //F1 - Algoritmo
        Parameters.SchedulingAlgorithm escalonador = Parameters.SchedulingAlgorithm.EDVSCHED1;
...
//        daxPaths.add(System.getProperty("user.dir")+"/config/dax/Protein1EOD_Final.xml");
        ...
        Utilidades.selectInfra = Utilidades.APENAS_CLUSTER;
...
//          daxPaths.add("/Users/weiweich/NetBeansProjects/WorkflowSim-1.0/config/dax/Montage_1000.xml");
            ...
            Logger.getLogger(TemplateProgram5.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "";
    }
}
